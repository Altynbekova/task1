...
public class AircraftFactory implements Comparable{
    ...
    public static Aircraft createAircraft (Aircraft a) throws IOException {
        ...
        {
            return new Airliner(UUID.randomUUID(), propertyManager.getProperty("airliner.1.modelName"),
        ...
        {
            return new Freighter(UUID.randomUUID(), propertyManager.getProperty("freighter.1.modelName"),
        ...
        {
            return new Trainer(UUID.randomUUID(), propertyManager.getProperty("trainer.1.modelName"),
